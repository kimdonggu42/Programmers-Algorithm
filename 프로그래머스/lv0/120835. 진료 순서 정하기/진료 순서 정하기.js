...
// 2. 내림차순으로 정렬한 각 요소의 index + 1한 값이 emergency 각 요소들의 응급도가 된다.  // [76, 24, 3] === [1, 2, 3]
// 3. 내림차순으로 졍렬한 각 요소의 index + 1한 값을 다시 원래 emergency 요소의 순서대로 위치시켜야 하기 때문에  // [3, 76, 24] === [3, 1, 2]
// 4. 내림차순으로 정렬한 배열에서 emergecny 요소의 순서(3->76->24)대로 index값을 찾은 후, 1을 더한 값을 빈 배열에 넣어준다.

// ex) [76, 24, 3]에서 3의 index 값 -> 76의 index 값 -> 24의 index 값 순서대로 빈 배열에 넣어준다.
